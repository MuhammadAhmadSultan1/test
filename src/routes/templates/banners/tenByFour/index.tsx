...
import BannerTenByFourOne from "../../../../components/banners/tenByFour/cardOne/front";
import BannerTenByFourTwo from "../../../../components/banners/tenByFour/cardTwo/front";
import BannerTenByFourThree from "../../../../components/banners/tenByFour/cardThree/front";
...
export const TenByFourBanners = ({
  ...
  const [selected, setSelected] = useState({
    card1: selectedCard.path === "components/banners/tenByFour/cardOne/front",
    card2: selectedCard.path === "components/banners/tenByFour/cardTwo/front",
    card3: selectedCard.path === "components/banners/tenByFour/cardThree/front",
  });
  ...
  const onSubmit: SubmitHandler<IHorizontalCard> = (formData) => {
    try {
      ...
      if (selectedData)
        dispatch(setSelectedTemplateData({ ...selectedData, sku: "109B1044" }));
      if (onClickNext) {
        onClickNext();
      }
    } catch (e) {
        ...
        <div className="flex md:flex-row flex-wrap flex-col w-full justify-center py-5 px-5 gap-4">
          {foundedTemplatesData.template1 && (
            <RadioButton
              ...
              value="components/banners/tenByFour/cardOne/front"
              attributes={{
                defaultChecked:
                  selectedCard.path ===
                  "components/banners/tenByFour/cardOne/front",
              }}
              onChange={() => {
                setSelected(() => ({
                  card1: true,
          ...
          {foundedTemplatesData.template2 && (
            <RadioButton
              ...
              register={register("selectedCard")}
              value="components/banners/tenByFour/cardTwo/front"
              attributes={{
                defaultChecked:
                  selectedCard.path ===
                  "components/banners/tenByFour/cardTwo/front",
              }}
              onChange={() => {
                setSelected(() => ({
                  card1: false,
          ...
          {foundedTemplatesData.template3 && (
            <RadioButton
              ...
              register={register("selectedCard")}
              value="components/banners/tenByFour/cardThree/front"
              attributes={{
                defaultChecked:
                  selectedCard.path ===
                  "components/banners/tenByFour/cardThree/front",
              }}
              onChange={() => {
                setSelected(() => ({
                  card1: false,
