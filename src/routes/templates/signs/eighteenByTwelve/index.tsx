...
import SignOne from "../../../../components/signs/eighteenByTwelve/cardOne/front";
import SignTwo from "../../../../components/signs/eighteenByTwelve/cardTwo/front";
import SignThree from "../../../../components/signs/eighteenByTwelve/cardThree/front";
...
export const EighteenByTwelveSigns = ({
  onClickBack,
  onClickNext,
}: ICommonProps) => {
  ...
  const [selected, setSelected] = useState({
    card1:
      selectedCard.path === "components/signs/eighteenByTwelve/cardOne/front",
    card2:
      selectedCard.path === "components/signs/eighteenByTwelve/cardTwo/front",
    card3:
      selectedCard.path === "components/signs/eighteenByTwelve/cardThree/front",
  });
  ...
  const onSubmit: SubmitHandler<IHorizontalCard> = (formData) => {
    try {
      ...
      if (selectedData)
        dispatch(setSelectedTemplateData({ ...selectedData, sku: "107S1812" }));
      if (onClickNext) {
        onClickNext();
      }
    } catch (e) {
      ...
      <div className="flex md:flex-row flex-wrap flex-col w-full justify-center py-5 px-5 gap-4">
        {foundedTemplatesData.template1 && (
          <RadioButton
            ...
            value="components/signs/eighteenByTwelve/cardOne/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/eighteenByTwelve/cardOne/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: true,
        ...
        {foundedTemplatesData.template2 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/signs/eighteenByTwelve/cardTwo/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/eighteenByTwelve/cardTwo/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: false,
        ...
        {foundedTemplatesData.template3 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/signs/eighteenByTwelve/cardThree/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/eighteenByTwelve/cardThree/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: false,
