...
import SignOne from "../../../../components/signs/thirtySixByTwentyFour/cardOne/front";
import SignTwo from "../../../../components/signs/thirtySixByTwentyFour/cardTwo/front";
import SignThree from "../../../../components/signs/thirtySixByTwentyFour/cardThree/front";
...
export const ThirtySixByTwentyFourSigns = ({
  onClickBack,
  onClickNext,
}: ICommonProps) => {
  ...
  const [selected, setSelected] = useState({
    card1:
      selectedCard.path ===
      "components/signs/thirtySixByTwentyFour/cardOne/front",
    card2:
      selectedCard.path ===
      "components/signs/thirtySixByTwentyFour/cardTwo/front",
    card3:
      selectedCard.path ===
      "components/signs/thirtySixByTwentyFour/cardThree/front",
  });
      ...
      <div className="flex md:flex-row flex-wrap flex-col w-full justify-center py-5 px-5 gap-4">
        {foundedTemplatesData.template1 && (
          <RadioButton
            ...
            value="components/signs/thirtySixByTwentyFour/cardOne/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/thirtySixByTwentyFour/cardOne/front",
        ...
        {foundedTemplatesData.template2 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/signs/thirtySixByTwentyFour/cardTwo/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/thirtySixByTwentyFour/cardTwo/front",
        ...
        {foundedTemplatesData.template3 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/signs/thirtySixByTwentyFour/cardThree/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/signs/thirtySixByTwentyFour/cardThree/front",
