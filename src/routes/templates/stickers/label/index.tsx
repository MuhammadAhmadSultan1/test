...
import LabelCircleOne from "../../../../components/stickers/labelCircle/cardOne/front";
import LabelCircleTwo from "../../../../components/stickers/labelCircle/cardTwo/front";
import LableCircleThree from "../../../../components/stickers/labelCircle/cardThree/front";
...
export const StickersLabel = ({ onClickBack, onClickNext }: ICommonProps) => {
  ...
  const [selected, setSelected] = useState({
    card1:
      selectedCard.path === "components/stickers/labelCircle/cardOne/front",
    card2:
      selectedCard.path === "components/stickers/labelCircle/cardTwo/front",
    card3:
      selectedCard.path === "components/stickers/labelCircle/cardThree/front",
  });
  ...
  const onSubmit: SubmitHandler<IHorizontalCard> = (formData) => {
    try {
      ...
      if (selectedData)
        dispatch(setSelectedTemplateData({ ...selectedData, sku: "105LC009" }));
      if (onClickNext) {
        onClickNext();
      }
    } catch (e) {
