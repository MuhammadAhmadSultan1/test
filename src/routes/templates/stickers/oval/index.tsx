...
import OvalOne from "../../../../components/stickers/oval/cardOne/front";
import OvalTwo from "../../../../components/stickers/oval/cardTwo/front";
import OvalThree from "../../../../components/stickers/oval/cardThree/front";
...
export const StickersOval = ({ onClickBack, onClickNext }: ICommonProps) => {
  ...
  const [selected, setSelected] = useState({
    card1: selectedCard.path === "components/stickers/oval/cardOne/front",
    card2: selectedCard.path === "components/stickers/oval/cardTwo/front",
    card3: selectedCard.path === "components/stickers/oval/cardThree/front",
  });
  ...
  const onSubmit: SubmitHandler<IHorizontalCard> = (formData) => {
    try {
      ...
      if (selectedData)
        dispatch(setSelectedTemplateData({ ...selectedData, sku: "104SO008" }));
      if (onClickNext) {
        onClickNext();
      }
    } catch (e) {
      ...
      <div className="flex md:flex-row flex-wrap flex-col w-full justify-center py-5 px-5 gap-4">
        {foundedTemplatesData.template1 && (
          <RadioButton
            ...
            value="components/stickers/oval/cardOne/front"
            attributes={{
              defaultChecked:
                selectedCard.path === "components/stickers/oval/cardOne/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: true,
        ...
        {foundedTemplatesData.template2 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/stickers/oval/cardTwo/front"
            attributes={{
              defaultChecked:
                selectedCard.path === "components/stickers/oval/cardTwo/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: false,
        ...
        {foundedTemplatesData.template3 && (
          <RadioButton
            ...
            register={register("selectedCard")}
            value="components/stickers/oval/cardThree/front"
            attributes={{
              defaultChecked:
                selectedCard.path ===
                "components/stickers/oval/cardThree/front",
            }}
            onChange={() => {
              setSelected(() => ({
                card1: false,
