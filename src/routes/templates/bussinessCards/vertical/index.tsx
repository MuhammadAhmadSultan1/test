...
import CardOne from "../../../../components/businessCards/vertical/cardOne/front";
import CardTwo from "../../../../components/businessCards/vertical/cardTwo/front";
import CardThree from "../../../../components/businessCards/vertical/cardThree/front";
...
export const VerticalCards = ({ onClickBack, onClickNext }: ICommonProps) => {
  ...
  const [selected, setSelected] = useState({
    card1:
      selectedCard.path === "components/businessCards/vertical/cardOne/front",
    card2:
      selectedCard.path === "components/businessCards/vertical/cardTwo/front",
    card3:
      selectedCard.path === "components/businessCards/vertical/cardThree/front",
  });
  ...
  const onSubmit: SubmitHandler<IHorizontalCard> = (formData) => {
    try {
      ...
      if (selectedData)
        dispatch(setSelectedTemplateData({ ...selectedData, sku: "102VC006" }));
      if (onClickNext) {
        onClickNext();
      }
    } catch (e) {
