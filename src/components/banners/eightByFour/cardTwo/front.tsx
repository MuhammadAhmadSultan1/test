...
export default function BannerEightByFourTwo(props: TCanvasCardProps) {
  ...
  return (
    ...
    >
      <Konva.Layer imageSmoothingEnabled>
        <CustomImage x={544} y={0} svgString={primaryTop} />
        <CustomImage x={644} y={100} svgString={darkRight} />
        <CustomImage x={308} y={0} svgString={secondaryLarge} />
        <CustomImage x={487} y={260} svgString={secondarySmall} />
        <CustomImage x={340} y={280} svgString={primaryBottom} />

        <CustomImage x={395} y={215} svgString={primaryCenter} />
