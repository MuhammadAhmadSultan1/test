...
export default function BannerEightByFourTwo(props: TCanvasCardProps) {
  ...
  const { primaryCircle, secondaryCircle, violetRect, primaryTile } =
    useGetCardSvgs({
  ...
  return (
    ...
    >
      <Konva.Layer imageSmoothingEnabled>
        <CustomImage x={391} y={0} svgString={violetRect} />
        <CustomImage x={379} y={0} svgString={secondaryCircle} />
        <CustomImage x={491} y={38} svgString={primaryCircle} />
        ...
        <Konva.Group x={36} y={105}>
          ...
          />
          <CustomImage x={0} y={160} svgString={primaryTile} />
        </Konva.Group>
