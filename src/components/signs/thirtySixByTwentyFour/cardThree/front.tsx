...
export default function SignThree(props: TCanvasCardProps) {
  ...
  const { primarySvg, arrowHeadSvg } = useGetSvg({
    ...
    >
      <Konva.Layer>
        {/* <Konva.Circle
          ...
          strokeWidth={6}
        /> */}
        <CustomImage x={0} y={0} svgString={primarySvg} />
        <CustomImage x={2243} y={407} svgString={arrowHeadSvg} />
        ...
        <Konva.Text
          ...
          height={text.templateAttributes.name.width}
