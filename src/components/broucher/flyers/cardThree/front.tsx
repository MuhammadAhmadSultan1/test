  ...
  return (
    ...
    >
      <Konva.Layer imageSmoothingEnabled>
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={33} y={814} svgString={phone} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={171} y={814} svgString={email} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={329} y={814} svgString={webSite} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={448} y={814} svgString={address} />
          <Konva.Text
            ref={
              props.editable
