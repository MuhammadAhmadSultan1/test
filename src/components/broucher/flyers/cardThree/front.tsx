  ...
  return (
    ...
    >
      <Konva.Layer imageSmoothingEnabled>
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={30} y={814} svgString={phone} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={145} y={814} svgString={email} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={326} y={814} svgString={webSite} />
          <Konva.Text
            ref={
              props.editable
        ...
        <Konva.Group x={0} y={0}>
          <CustomImage x={441} y={814} svgString={address} />
          <Konva.Text
            ref={
              props.editable
